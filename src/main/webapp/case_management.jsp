    ...
    <div class="table-box">
        ...
        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
            ...
            <tr ><!-- ng-repeat="pojo in list" -->
                ...
                <td>sdad</td>
                <td>ea</td>
                <td><span ng-if="true">已核定补缴本金，请出具补缴通知书</span>
                    <span ng-if="pojo.registrationOfCases.warningTime>5&&pojo.registrationOfCases.warningTime<50"
                          style="color:red;">已经超过五天，仍未出具补缴通知书</span>
                    <span ng-if="pojo.registrationOfCases.warningTime>pojo.registrationOfCases.maxtime"
                          style="color:red;">该案件已超时，请尽快处理！！</span>
                </td>
                <td class="text-center">
                    ...
                    <button ng-if="pojo.registrationOfCases.maxtime==50" type="button"
			...
			<tr ><!-- ng-repeat="pojo in list" -->
			    ...
			    <td>sdad</td>
			    <td>ea</td>
			    <td><span ng-if="pojo.registrationOfCases.warningTime<5">已核定补缴本金，请出具补缴通知书</span>
			        <span ng-if="true"
			              style="color:red;">已经超过五天，仍未出具补缴通知书</span>
			        <span ng-if="pojo.registrationOfCases.warningTime>pojo.registrationOfCases.maxtime"
			              style="color:red;">该案件已超时，请尽快处理！！</span>
